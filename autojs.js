...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" title="学习强国辅助"/>
                <tabs id="tabs"/>
            </appbar>
            <viewpager id="viewpager">
                <frame>
                    <ScrollView>
                    <vertical>
                        <button text="先点我开启无障碍和悬浮窗" textColor="red"  style="Widget.AppCompat.Button.Colored" id="click_me" w="*" />
...
//设置滑动页面的标题
ui.viewpager.setTitles(["自动", "数据配置", "题库", "更新记录"]);
//让滑动页面和标签栏联动
...
ui.click_me.on("click", ()=>{
    toast("选择'强国辅助'开启无障碍");
    engines.execScript("选择'强国辅助'开启无障碍","auto.waitFor();console.show();console.hide();");
});
